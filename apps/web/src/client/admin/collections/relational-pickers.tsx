      ...
      >
        ...
        <DialogBody>
          ...
          <div style={{ flex: 1, minWidth: 0, padding: 14, display: "flex", flexDirection: "column", gap: 10, overflowY: "auto" }}>
            ...
            <div
              className={`flex cursor-pointer items-center gap-3.5 rounded-surface border-[1.5px] border-dashed px-3.5 py-2.5 transition-all ${dragOver ? "scale-[1.005] border-solid border-primary bg-muted" : "border-border bg-[color-mix(in_oklch,var(--muted)_22%,var(--card))] hover:border-interactive-hover-border hover:bg-muted"}`}
              onClick={() => fileInputRef.current?.click()}
              role="button"
              tabIndex={0}
            >
              <div className="grid size-8 shrink-0 place-items-center rounded-control bg-muted text-primary">
                <I.Upload size={16} />
              </div>
