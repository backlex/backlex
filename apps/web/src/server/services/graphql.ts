...
const schemaVersionQueryFields: Record<string, GraphQLFieldConfig<unknown, GqlCtx>> = {
  schemaSnapshots: {
...
const schemaVersionMutationFields: Record<string, GraphQLFieldConfig<unknown, GqlCtx>> = {
