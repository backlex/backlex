...
--   mcp_tools     — JSON array of allowed tool names, or NULL = all tools.
--   mcp_read_only — when 1, the MCP layer refuses every write tool (insert /
...
ALTER TABLE api_keys ADD COLUMN mcp_tools TEXT;
--> statement-breakpoint
ALTER TABLE api_keys ADD COLUMN mcp_read_only INTEGER NOT NULL DEFAULT 0;
