...
export const easypost = defineProvider({
  ...
  configFields: [
    ...
    { key: "fromCompany", label: "Ship-from company" },
    { key: "fromStreet1", label: "Ship-from street" },
    { key: "fromStreet2", label: "Ship-from street 2" },
    { key: "fromCity", label: "Ship-from city" },
    { key: "fromState", label: "Ship-from state/province" },
    ...
    { key: "fromPhone", label: "Ship-from phone" },
  ],
  tasks: [
    {
      id: "book_shipment",
      ...
      settingFields: [
        ...
        { key: "toStreet2Field", label: "Recipient street 2 field" },
        { key: "toCityField", label: "Recipient city field" },
        { key: "toStateField", label: "Recipient state/province field" },
        ...
        { key: "toPhoneField", label: "Recipient phone field" },
        { key: "weightField", label: "Weight field", placeholder: "the row field holding weight in ounces" },
        { key: "lengthField", label: "Length field (inches)" },
        { key: "widthField", label: "Width field (inches)" },
        { key: "heightField", label: "Height field (inches)" },
        {
